...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.35.0"
  WORKING_DIRECTORY "/home/ego/projects/minecpp/build/_deps/grpc-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.35.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.35.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/ego/projects/minecpp/build/_deps/grpc-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ego/projects/minecpp/build/_deps/grpc-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
