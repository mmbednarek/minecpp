...
class AddReferencesRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_engine_id();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_player_id();
...
class AddReferencesResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_target_engine_id();
...
class RemoveReferencesRequest final :
 ...
 public:
  ...
  inline RemoveReferencesRequest* New() const final {
    return new RemoveReferencesRequest();
  }
...
class EmptyResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minecpp.proto.service.chunk_storage.v1.EmptyResponse) */ {
 public:
