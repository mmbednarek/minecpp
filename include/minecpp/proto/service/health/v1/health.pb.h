...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
        descriptor_table_minecpp_2fproto_2fservice_2fhealth_2fv1_2fhealth_2eproto;
...
Arena::CreateMaybeMessage<::minecpp::proto::service::health::v1::Request>(Arena *);
template<>
::minecpp::proto::service::health::v1::ServiceStatus *
Arena::CreateMaybeMessage<::minecpp::proto::service::health::v1::ServiceStatus>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace minecpp { namespace proto { namespace service { namespace health { namespace v1 {
...
class Request final
    : public ::PROTOBUF_NAMESPACE_ID::internal::
              ZeroFieldsBase /* @@protoc_insertion_point(class_definition:minecpp.proto.service.health.v1.Request) */
{
 public:
   ...
   void MergeFrom(const Request &from) { ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl(this, from); }

 public:
 private:
   friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.service.health.v1.Request"; }
...
class ServiceStatus final
    : public ::PROTOBUF_NAMESPACE_ID::
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.service.health.v1.ServiceStatus) */
{
 public:
   ...
   ServiceStatus(ServiceStatus &&from) noexcept : ServiceStatus() { *this = ::std::move(from); }
   ...
   static const ServiceStatus &default_instance() { return *internal_default_instance(); }
   static inline const ServiceStatus *internal_default_instance()
   {
      return reinterpret_cast<const ServiceStatus *>(&_ServiceStatus_default_instance_);
   }
 ...
 protected:
   explicit ServiceStatus(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned = false);
...
// string service_name = 1;
inline void ServiceStatus::clear_service_name() { service_name_.ClearToEmpty(); }
...
inline PROTOBUF_ALWAYS_INLINE void ServiceStatus::set_service_name(ArgT0 &&arg0, ArgT... args)
{
...
inline const std::string &ServiceStatus::_internal_service_name() const { return service_name_.Get(); }
...
// string service_version = 2;
inline void ServiceStatus::clear_service_version() { service_version_.ClearToEmpty(); }
...
template<typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void ServiceStatus::set_service_version(ArgT0 &&arg0, ArgT... args)
{

   service_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string &ServiceStatus::_internal_service_version() const { return service_version_.Get(); }
inline void ServiceStatus::_internal_set_service_version(const std::string &value)
{

   service_version_.Set(value, GetArenaForAllocation());
}
inline std::string *ServiceStatus::_internal_mutable_service_version()
{

   return service_version_.Mutable(GetArenaForAllocation());
}
inline std::string *ServiceStatus::release_service_version()
{
   ...
   return service_version_.Release();
}
inline void ServiceStatus::set_allocated_service_version(std::string *service_version)
{
   ...
   service_version_.SetAllocated(service_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
   if (service_version_.IsDefault()) {
