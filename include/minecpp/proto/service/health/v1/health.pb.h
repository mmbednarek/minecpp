...
class Request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minecpp.proto.service.health.v1.Request) */ {
 public:
...
class ServiceStatus final :
 ...
 public:
  ...
  inline ServiceStatus* New() const final {
    return new ServiceStatus();
  }

  ServiceStatus* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_service_version();
