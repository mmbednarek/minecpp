...
{
 public:
   static constexpr char const *service_full_name() { return "minecpp.proto.service.health.v1.HealthService"; }
   class StubInterface
   {
    public:
      virtual ~StubInterface() {}
      virtual ::grpc::Status GetServiceStatus(::grpc::ClientContext *context,
                                              const ::minecpp::proto::service::health::v1::Request &request,
                                              ::minecpp::proto::service::health::v1::ServiceStatus *response) = 0;
      std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<::minecpp::proto::service::health::v1::ServiceStatus>>
      AsyncGetServiceStatus(::grpc::ClientContext *context,
                            const ::minecpp::proto::service::health::v1::Request &request, ::grpc::CompletionQueue *cq)
      {
         return std::unique_ptr<
                 ::grpc::ClientAsyncResponseReaderInterface<::minecpp::proto::service::health::v1::ServiceStatus>>(
   ...
   class Stub final : public StubInterface
   {
    public:
      ...
      ::grpc::Status GetServiceStatus(::grpc::ClientContext *context,
                                      const ::minecpp::proto::service::health::v1::Request &request,
   ...
   class WithAsyncMethod_GetServiceStatus : public BaseClass
   {
    ...
    public:
      WithAsyncMethod_GetServiceStatus() { ::grpc::Service::MarkMethodAsync(0); }
      ~WithAsyncMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      ...
      void RequestGetServiceStatus(
              ...
              ::grpc::ServerAsyncResponseWriter<::minecpp::proto::service::health::v1::ServiceStatus> *response,
    ...
    public:
      WithCallbackMethod_GetServiceStatus()
      {
         ::grpc::Service::MarkMethodCallback(
                 0, new ::grpc::internal::CallbackUnaryHandler<::minecpp::proto::service::health::v1::Request,
                                       ...
                                       ::minecpp::proto::service::health::v1::ServiceStatus> *allocator)
      {
         ...
         static_cast<::grpc::internal::CallbackUnaryHandler<::minecpp::proto::service::health::v1::Request,
                                                            ::minecpp::proto::service::health::v1::ServiceStatus> *>(
                 handler)
                 ->SetMessageAllocator(allocator);
      }
      ~WithCallbackMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status GetServiceStatus(::grpc::ServerContext * /*context*/,
                                      const ::minecpp::proto::service::health::v1::Request * /*request*/,
                                      ::minecpp::proto::service::health::v1::ServiceStatus * /*response*/) override
   ...
   class WithGenericMethod_GetServiceStatus : public BaseClass
   {
    ...
    public:
      WithGenericMethod_GetServiceStatus() { ::grpc::Service::MarkMethodGeneric(0); }
      ~WithGenericMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status GetServiceStatus(::grpc::ServerContext * /*context*/,
                                      const ::minecpp::proto::service::health::v1::Request * /*request*/,
                                      ::minecpp::proto::service::health::v1::ServiceStatus * /*response*/) override
   ...
   class WithRawMethod_GetServiceStatus : public BaseClass
   {
    ...
    public:
      WithRawMethod_GetServiceStatus() { ::grpc::Service::MarkMethodRaw(0); }
      ~WithRawMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status GetServiceStatus(::grpc::ServerContext * /*context*/,
                                      const ::minecpp::proto::service::health::v1::Request * /*request*/,
                                      ::minecpp::proto::service::health::v1::ServiceStatus * /*response*/) override
   ...
   class WithRawCallbackMethod_GetServiceStatus : public BaseClass
   {
    ...
    public:
      ...
      ~WithRawCallbackMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status GetServiceStatus(::grpc::ServerContext * /*context*/,
                                      const ::minecpp::proto::service::health::v1::Request * /*request*/,
                                      ::minecpp::proto::service::health::v1::ServiceStatus * /*response*/) override
    ...
    public:
      WithStreamedUnaryMethod_GetServiceStatus()
      {
         ::grpc::Service::MarkMethodStreamed(
                 0, new ::grpc::internal::StreamedUnaryHandler<::minecpp::proto::service::health::v1::Request,
                                                               ::minecpp::proto::service::health::v1::ServiceStatus>(
                            [this](::grpc::ServerContext *context,
                                   ::grpc::ServerUnaryStreamer<::minecpp::proto::service::health::v1::Request,
                                                               ::minecpp::proto::service::health::v1::ServiceStatus>
                                           *streamer) { return this->StreamedGetServiceStatus(context, streamer); }));
      }
      ~WithStreamedUnaryMethod_GetServiceStatus() override { BaseClassMustBeDerivedFromService(this); }
      ...
      virtual ::grpc::Status
      StreamedGetServiceStatus(::grpc::ServerContext *context,
                               ::grpc::ServerUnaryStreamer<::minecpp::proto::service::health::v1::Request,
                                                           ::minecpp::proto::service::health::v1::ServiceStatus>
