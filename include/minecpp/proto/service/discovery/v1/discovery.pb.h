...
class DiscoveryRequest final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 resource_version() const;
  void set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_resource_version() const;
  void _internal_set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 resource_version_;
...
class RegisterRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::minecpp::proto::service::discovery::v1::Endpoint* release_endpoint();
...
class EmptyResult final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minecpp.proto.service.discovery.v1.EmptyResult) */ {
 public:
  inline EmptyResult() : EmptyResult(nullptr) {}
  ~EmptyResult() override;
  ...
  inline EmptyResult* New() const final {
    return new EmptyResult();
  }

  EmptyResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<EmptyResult>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const EmptyResult& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(EmptyResult* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 DiscoveryRequest::_internal_resource_version() const {
  return resource_version_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 DiscoveryRequest::resource_version() const {
...
inline void DiscoveryRequest::_internal_set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  resource_version_ = value;
}
inline void DiscoveryRequest::set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 DiscoveryResponse::_internal_resource_version() const {
  return resource_version_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 DiscoveryResponse::resource_version() const {
  // @@protoc_insertion_point(field_get:minecpp.proto.service.discovery.v1.DiscoveryResponse.resource_version)
  return _internal_resource_version();
}
inline void DiscoveryResponse::_internal_set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  resource_version_ = value;
}
inline void DiscoveryResponse::set_resource_version(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_resource_version(value);
