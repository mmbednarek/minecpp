...
{
 public:
   static constexpr char const *service_full_name() { return "minecpp.proto.service.engine.v1.EngineService"; }
   class StubInterface
   {
    public:
      ...
      {
         return std::unique_ptr<::grpc::ClientReaderWriterInterface<::minecpp::proto::event::serverbound::v1::Event,
                                                                    ::minecpp::proto::event::clientbound::v1::Event>>(
                 JoinRaw(context));
      }
      std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<::minecpp::proto::event::serverbound::v1::Event,
                                                               ::minecpp::proto::event::clientbound::v1::Event>>
      AsyncJoin(::grpc::ClientContext *context, ::grpc::CompletionQueue *cq, void *tag)
      {
         return std::unique_ptr<::grpc::ClientAsyncReaderWriterInterface<
                 ::minecpp::proto::event::serverbound::v1::Event, ::minecpp::proto::event::clientbound::v1::Event>>(
      ...
      class async_interface
      {
       public:
         ...
         virtual void Join(::grpc::ClientContext *context,
   ...
   class Stub final : public StubInterface
   {
    public:
      ...
      AsyncJoin(::grpc::ClientContext *context, ::grpc::CompletionQueue *cq, void *tag)
      {
         return std::unique_ptr<::grpc::ClientAsyncReaderWriter<::minecpp::proto::event::serverbound::v1::Event,
                                                                ::minecpp::proto::event::clientbound::v1::Event>>(
                 AsyncJoinRaw(context, cq, tag));
      }
      std::unique_ptr<::grpc::ClientAsyncReaderWriter<::minecpp::proto::event::serverbound::v1::Event,
      ...
      {
       public:
         void Join(::grpc::ClientContext *context,
                   ::grpc::ClientBidiReactor<::minecpp::proto::event::serverbound::v1::Event,
   ...
   class WithAsyncMethod_Join : public BaseClass
   {
    ...
    public:
      WithAsyncMethod_Join() { ::grpc::Service::MarkMethodAsync(0); }
      ~WithAsyncMethod_Join() override { BaseClassMustBeDerivedFromService(this); }
    ...
    public:
      WithCallbackMethod_Join()
      {
         ::grpc::Service::MarkMethodCallback(
                 0, new ::grpc::internal::CallbackBidiHandler<::minecpp::proto::event::serverbound::v1::Event,
                                                              ::minecpp::proto::event::clientbound::v1::Event>(
                            [this](::grpc::CallbackServerContext *context) { return this->Join(context); }));
      }
      ~WithCallbackMethod_Join() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status
      Join(::grpc::ServerContext * /*context*/,
           ::grpc::ServerReaderWriter<::minecpp::proto::event::clientbound::v1::Event,
   ...
   class WithGenericMethod_Join : public BaseClass
   {
    ...
    public:
      WithGenericMethod_Join() { ::grpc::Service::MarkMethodGeneric(0); }
      ~WithGenericMethod_Join() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status
      Join(::grpc::ServerContext * /*context*/,
           ::grpc::ServerReaderWriter<::minecpp::proto::event::clientbound::v1::Event,
   ...
   class WithRawMethod_Join : public BaseClass
   {
    ...
    public:
      WithRawMethod_Join() { ::grpc::Service::MarkMethodRaw(0); }
      ~WithRawMethod_Join() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status
      Join(::grpc::ServerContext * /*context*/,
           ::grpc::ServerReaderWriter<::minecpp::proto::event::clientbound::v1::Event,
   ...
   class WithRawCallbackMethod_Join : public BaseClass
   {
    ...
    public:
      ...
      ~WithRawCallbackMethod_Join() override { BaseClassMustBeDerivedFromService(this); }
      // disable synchronous version of this method
      ::grpc::Status
      Join(::grpc::ServerContext * /*context*/,
           ::grpc::ServerReaderWriter<::minecpp::proto::event::clientbound::v1::Event,
