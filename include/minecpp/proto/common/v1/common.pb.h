...
template<>
::minecpp::proto::common::v1::BlockState *Arena::CreateMaybeMessage<::minecpp::proto::common::v1::BlockState>(Arena *);
template<>
::minecpp::proto::common::v1::ChunkPosition *
Arena::CreateMaybeMessage<::minecpp::proto::common::v1::ChunkPosition>(Arena *);
template<>
::minecpp::proto::common::v1::Gameplay *Arena::CreateMaybeMessage<::minecpp::proto::common::v1::Gameplay>(Arena *);
template<>
::minecpp::proto::common::v1::Vector3f *Arena::CreateMaybeMessage<::minecpp::proto::common::v1::Vector3f>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace minecpp { namespace proto { namespace common { namespace v1 {
...
{
   return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DimensionType>(DimensionType_descriptor(), name, value);
}
enum Difficulty : int
{
   Easy                                    = 0,
...
inline bool PlayerDiggingState_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PlayerDiggingState *value)
{
   return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<PlayerDiggingState>(PlayerDiggingState_descriptor(), name,
                                                                                value);
}
enum Face : int
{
              ...
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.common.v1.ChunkPosition) */
{
 public:
   ...
   ChunkPosition(ChunkPosition &&from) noexcept : ChunkPosition() { *this = ::std::move(from); }
   ...
   static const ChunkPosition &default_instance() { return *internal_default_instance(); }
   ...
   friend void swap(ChunkPosition &a, ChunkPosition &b) { a.Swap(&b); }
 ...
 private:
   ...
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.common.v1.ChunkPosition"; }
              ...
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.common.v1.BlockPosition) */
{
 public:
   ...
   BlockPosition(BlockPosition &&from) noexcept : BlockPosition() { *this = ::std::move(from); }
   ...
   static const BlockPosition &default_instance() { return *internal_default_instance(); }
   ...
   friend void swap(BlockPosition &a, BlockPosition &b) { a.Swap(&b); }
 ...
 private:
   friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.common.v1.BlockPosition"; }
              ...
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.common.v1.BlockState) */
{
 public:
   ...
   BlockState(BlockState &&from) noexcept : BlockState() { *this = ::std::move(from); }
   ...
   static const BlockState &default_instance() { return *internal_default_instance(); }
 ...
 private:
   friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.common.v1.BlockState"; }
...
class Gameplay final : public ::PROTOBUF_NAMESPACE_ID::
                               Message /* @@protoc_insertion_point(class_definition:minecpp.proto.common.v1.Gameplay) */
{
 public:
   ...
   Gameplay(Gameplay &&from) noexcept : Gameplay() { *this = ::std::move(from); }
   ...
   static const Gameplay &default_instance() { return *internal_default_instance(); }
   ...
   friend void swap(Gameplay &a, Gameplay &b) { a.Swap(&b); }
 ...
 private:
   friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.common.v1.Gameplay"; }
...
class Vector3f final : public ::PROTOBUF_NAMESPACE_ID::
                               Message /* @@protoc_insertion_point(class_definition:minecpp.proto.common.v1.Vector3f) */
{
 public:
   ...
   Vector3f(Vector3f &&from) noexcept : Vector3f() { *this = ::std::move(from); }
   ...
   static const Vector3f &default_instance() { return *internal_default_instance(); }
   static inline const Vector3f *internal_default_instance()
   {
      return reinterpret_cast<const Vector3f *>(&_Vector3f_default_instance_);
   }
 ...
 private:
   friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.common.v1.Vector3f"; }

 protected:
   explicit Vector3f(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned = false);
...
// int32 x = 1;
inline void ChunkPosition::clear_x() { x_ = 0; }
inline int32_t ChunkPosition::_internal_x() const { return x_; }
inline int32_t ChunkPosition::x() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.ChunkPosition.x)
   return _internal_x();
}
inline void ChunkPosition::_internal_set_x(int32_t value) { x_ = value; }
...
// int32 z = 2;
inline void ChunkPosition::clear_z() { z_ = 0; }
inline int32_t ChunkPosition::_internal_z() const { return z_; }
inline int32_t ChunkPosition::z() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.ChunkPosition.z)
   return _internal_z();
}
inline void ChunkPosition::_internal_set_z(int32_t value) { z_ = value; }
...
// int32 x = 1;
inline void BlockPosition::clear_x() { x_ = 0; }
inline int32_t BlockPosition::_internal_x() const { return x_; }
inline int32_t BlockPosition::x() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.BlockPosition.x)
   return _internal_x();
}
inline void BlockPosition::_internal_set_x(int32_t value) { x_ = value; }
...
// int32 y = 2;
inline void BlockPosition::clear_y() { y_ = 0; }
inline int32_t BlockPosition::_internal_y() const { return y_; }
inline int32_t BlockPosition::y() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.BlockPosition.y)
   return _internal_y();
}
inline void BlockPosition::_internal_set_y(int32_t value) { y_ = value; }
...
// int32 z = 3;
inline void BlockPosition::clear_z() { z_ = 0; }
inline int32_t BlockPosition::_internal_z() const { return z_; }
inline int32_t BlockPosition::z() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.BlockPosition.z)
   return _internal_z();
}
inline void BlockPosition::_internal_set_z(int32_t value) { z_ = value; }
...
// uint32 block_state = 1;
inline void BlockState::clear_block_state() { block_state_ = 0u; }
inline uint32_t BlockState::_internal_block_state() const { return block_state_; }
...
inline void BlockState::_internal_set_block_state(uint32_t value) { block_state_ = value; }
...
// .minecpp.proto.common.v1.DimensionType dimension = 1;
inline void Gameplay::clear_dimension() { dimension_ = 0; }
...
inline void Gameplay::_internal_set_dimension(::minecpp::proto::common::v1::DimensionType value) { dimension_ = value; }
...
// uint64 seed = 2;
inline void Gameplay::clear_seed() { seed_ = uint64_t{0u}; }
inline uint64_t Gameplay::_internal_seed() const { return seed_; }
inline uint64_t Gameplay::seed() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.Gameplay.seed)
   return _internal_seed();
}
inline void Gameplay::_internal_set_seed(uint64_t value) { seed_ = value; }
...
// .minecpp.proto.common.v1.GameMode mode = 3;
inline void Gameplay::clear_mode() { mode_ = 0; }
...
inline void Gameplay::_internal_set_mode(::minecpp::proto::common::v1::GameMode value) { mode_ = value; }
...
// .minecpp.proto.common.v1.WorldType world = 4;
inline void Gameplay::clear_world() { world_ = 0; }
...
inline void Gameplay::_internal_set_world(::minecpp::proto::common::v1::WorldType value) { world_ = value; }
...
// int32 view_distance = 5;
inline void Gameplay::clear_view_distance() { view_distance_ = 0; }
inline int32_t Gameplay::_internal_view_distance() const { return view_distance_; }
...
inline void Gameplay::_internal_set_view_distance(int32_t value) { view_distance_ = value; }
...
// bool hardcore = 6;
inline void Gameplay::clear_hardcore() { hardcore_ = false; }
inline bool Gameplay::_internal_hardcore() const { return hardcore_; }
...
inline void Gameplay::_internal_set_hardcore(bool value) { hardcore_ = value; }
...
// int32 max_players = 7;
inline void Gameplay::clear_max_players() { max_players_ = 0; }
inline int32_t Gameplay::_internal_max_players() const { return max_players_; }
...
inline void Gameplay::_internal_set_max_players(int32_t value) { max_players_ = value; }
...
// bool reduced_debug_info = 8;
inline void Gameplay::clear_reduced_debug_info() { reduced_debug_info_ = false; }
inline bool Gameplay::_internal_reduced_debug_info() const { return reduced_debug_info_; }
...
inline void Gameplay::_internal_set_reduced_debug_info(bool value) { reduced_debug_info_ = value; }
...
// bool do_immediate_respawn = 9;
inline void Gameplay::clear_do_immediate_respawn() { do_immediate_respawn_ = false; }
inline bool Gameplay::_internal_do_immediate_respawn() const { return do_immediate_respawn_; }
...
inline void Gameplay::_internal_set_do_immediate_respawn(bool value) { do_immediate_respawn_ = value; }
...
// .minecpp.proto.common.v1.Difficulty difficulty = 10;
inline void Gameplay::clear_difficulty() { difficulty_ = 0; }
...
inline void Gameplay::_internal_set_difficulty(::minecpp::proto::common::v1::Difficulty value) { difficulty_ = value; }
...
// float x = 1;
inline void Vector3f::clear_x() { x_ = 0; }
inline float Vector3f::_internal_x() const { return x_; }
inline float Vector3f::x() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.Vector3f.x)
   return _internal_x();
}
inline void Vector3f::_internal_set_x(float value) { x_ = value; }
...
// float y = 2;
inline void Vector3f::clear_y() { y_ = 0; }
inline float Vector3f::_internal_y() const { return y_; }
inline float Vector3f::y() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.Vector3f.y)
   return _internal_y();
}
inline void Vector3f::_internal_set_y(float value) { y_ = value; }
...
// float z = 3;
inline void Vector3f::clear_z() { z_ = 0; }
inline float Vector3f::_internal_z() const { return z_; }
inline float Vector3f::z() const
{
   // @@protoc_insertion_point(field_get:minecpp.proto.common.v1.Vector3f.z)
   return _internal_z();
}
inline void Vector3f::_internal_set_z(float value) { z_ = value; }
