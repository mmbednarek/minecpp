...
PROTOBUF_NAMESPACE_OPEN
template<>
::minecpp::proto::player::v1::PlayerId *Arena::CreateMaybeMessage<::minecpp::proto::player::v1::PlayerId>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace minecpp { namespace proto { namespace player { namespace v1 {

// ===================================================================

class PlayerId final : public ::PROTOBUF_NAMESPACE_ID::
                               Message /* @@protoc_insertion_point(class_definition:minecpp.proto.player.v1.PlayerId) */
{
 public:
   ...
   PlayerId(PlayerId &&from) noexcept : PlayerId() { *this = ::std::move(from); }
   ...
   static const PlayerId &default_instance() { return *internal_default_instance(); }
 ...
 private:
   ...
   static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "minecpp.proto.player.v1.PlayerId"; }
...
// uint64 lower = 1;
inline void PlayerId::clear_lower() { lower_ = uint64_t{0u}; }
inline uint64_t PlayerId::_internal_lower() const { return lower_; }
...
inline void PlayerId::_internal_set_lower(uint64_t value) { lower_ = value; }
...
// uint64 upper = 2;
inline void PlayerId::clear_upper() { upper_ = uint64_t{0u}; }
inline uint64_t PlayerId::_internal_upper() const { return upper_; }
...
inline void PlayerId::_internal_set_upper(uint64_t value) { upper_ = value; }
