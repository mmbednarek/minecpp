...
{
 public:
   inline Chunk_Section() :
       Chunk_Section(nullptr)
   {
   }
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int32_t> *Chunk_Section::_internal_mutable_palette()
{
   return &palette_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int64_t> &Chunk_Section::_internal_data() const
{
   return data_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int64_t> *Chunk_Section::_internal_mutable_data()
{
   return &data_;
}
...
inline std::string *Chunk_Section::_internal_mutable_sky_light()
{
   ...
   return sky_light_.Mutable(GetArenaForAllocation());
}
