...
void Dispatcher::acknowledge_player_digging(player::Id player_id, game::BlockPosition &pos, game::BlockState block_state, game::PlayerDiggingState state, bool successful) {
