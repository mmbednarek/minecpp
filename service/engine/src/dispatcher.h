...
class Dispatcher : public minecpp::game::Notifier
{
 ...
 public:
   ...
   void acknowledge_player_digging(player::Id player_id, int sequence_id) override;
   ...
   void set_inventory_slot(player::Id player_id, game::item::ItemId item_id, game::SlotId slot_id,
