...
inline void AddReferencesRequest::_internal_set_engine_id(const std::string& value) {
  ...
  engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void AddReferencesRequest::set_engine_id(const char* value) {
  ...
  engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void AddReferencesRequest::set_engine_id(const void* value,
  ...
  engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* AddReferencesRequest::_internal_mutable_engine_id() {
  ...
  return engine_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void AddReferencesResponse::_internal_set_target_engine_id(const std::string& value) {
  ...
  target_engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void AddReferencesResponse::set_target_engine_id(const char* value) {
  ...
  target_engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void AddReferencesResponse::set_target_engine_id(const void* value,
  ...
  target_engine_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* AddReferencesResponse::_internal_mutable_target_engine_id() {
  ...
  return target_engine_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
