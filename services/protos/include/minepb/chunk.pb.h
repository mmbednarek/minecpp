...
inline void NetChunk_Section::_internal_set_block_light(const std::string& value) {
  ...
  block_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void NetChunk_Section::set_block_light(const char* value) {
  ...
  block_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void NetChunk_Section::set_block_light(const void* value,
  ...
  block_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* NetChunk_Section::_internal_mutable_block_light() {
  ...
  return block_light_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void NetChunk_Section::_internal_set_sky_light(const std::string& value) {
  ...
  sky_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void NetChunk_Section::set_sky_light(const char* value) {
  ...
  sky_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void NetChunk_Section::set_sky_light(const void* value,
  ...
  sky_light_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* NetChunk_Section::_internal_mutable_sky_light() {
  ...
  return sky_light_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
