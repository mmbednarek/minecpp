...
class UpdateBlock PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_chunk_x() const;
  void _internal_set_chunk_x(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_chunk_z() const;
  void _internal_set_chunk_z(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 UpdateBlock::_internal_chunk_x() const {
  return chunk_x_;
}
...
inline void UpdateBlock::_internal_set_chunk_x(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 UpdateBlock::_internal_chunk_z() const {
  return chunk_z_;
}
...
inline void UpdateBlock::_internal_set_chunk_z(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 UpdateBlock::_internal_offset() const {
  return offset_;
}
...
inline void UpdateBlock::_internal_set_offset(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void TransferPlayer::_internal_set_target_engine(const std::string& value) {
  ...
  target_engine_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TransferPlayer::set_target_engine(const char* value) {
  ...
  target_engine_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void TransferPlayer::set_target_engine(const void* value,
  ...
  target_engine_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TransferPlayer::_internal_mutable_target_engine() {
  ...
  return target_engine_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
