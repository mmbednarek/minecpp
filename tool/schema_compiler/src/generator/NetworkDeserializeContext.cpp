...
NetworkDeserializeContext::NetworkDeserializeContext(Type type, std::string name,
                                                     std::unique_ptr<mb::codegen::expression> in_destination,
                                                     AnnotationList in_annotations, int depth,
