...
// source: services/protos/chunk.proto

#include "services/protos/chunk.pb.h"
...
extern PROTOBUF_INTERNAL_EXPORT_services_2fprotos_2fchunk_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto;
namespace minecpp {
namespace chunk {
...
static void InitDefaultsscc_info_NetChunk_services_2fprotos_2fchunk_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_NetChunk_services_2fprotos_2fchunk_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_NetChunk_services_2fprotos_2fchunk_2eproto}, {
      &scc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto.base,}};

static void InitDefaultsscc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_services_2fprotos_2fchunk_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_services_2fprotos_2fchunk_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_services_2fprotos_2fchunk_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_services_2fprotos_2fchunk_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_services_2fprotos_2fchunk_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\033services/protos/chunk.proto\022\rminecpp.c"
  "hunk\"\261\002\n\010NetChunk\022\r\n\005pos_x\030\001 \001(\005\022\r\n\005pos_"
  "z\030\002 \001(\005\022\014\n\004full\030\003 \001(\010\022\022\n\006biomes\030\004 \003(\005B\002\020"
  "\001\022\030\n\020hm_world_surface\030\005 \003(\003\022\032\n\022hm_motion"
  "_blocking\030\006 \003(\003\0221\n\010sections\030\007 \003(\0132\037.mine"
  "cpp.chunk.NetChunk.Section\032|\n\007Section\022\t\n"
  "\001y\030\001 \001(\005\022\014\n\004bits\030\002 \001(\005\022\021\n\tref_count\030\003 \001("
  "\005\022\017\n\007palette\030\004 \003(\005\022\014\n\004data\030\005 \003(\003\022\023\n\013bloc"
  "k_light\030\006 \001(\014\022\021\n\tsky_light\030\007 \001(\014b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_services_2fprotos_2fchunk_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_services_2fprotos_2fchunk_2eproto_sccs[2] = {
  &scc_info_NetChunk_services_2fprotos_2fchunk_2eproto.base,
  &scc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_services_2fprotos_2fchunk_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_services_2fprotos_2fchunk_2eproto = {
  false, false, descriptor_table_protodef_services_2fprotos_2fchunk_2eproto, "services/protos/chunk.proto", 360,
  &descriptor_table_services_2fprotos_2fchunk_2eproto_once, descriptor_table_services_2fprotos_2fchunk_2eproto_sccs, descriptor_table_services_2fprotos_2fchunk_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_services_2fprotos_2fchunk_2eproto::offsets,
  file_level_metadata_services_2fprotos_2fchunk_2eproto, 2, file_level_enum_descriptors_services_2fprotos_2fchunk_2eproto, file_level_service_descriptors_services_2fprotos_2fchunk_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_services_2fprotos_2fchunk_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_services_2fprotos_2fchunk_2eproto)), true);
namespace minecpp {
namespace chunk {
...
NetChunk_Section::NetChunk_Section(const NetChunk_Section& from)
  ...
  if (!from._internal_block_light().empty()) {
    block_light_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_block_light(),
      GetArena());
  }
  sky_light_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_sky_light().empty()) {
    sky_light_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_sky_light(),
      GetArena());
  }
  ::memcpy(&y_, &from.y_,
...
void NetChunk_Section::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_NetChunk_Section_services_2fprotos_2fchunk_2eproto.base);
  block_light_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  sky_light_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void NetChunk::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_NetChunk_services_2fprotos_2fchunk_2eproto.base);
