...
{
   switch (color.index()) {
   case 0: return ColorId::Snow;
   case 1: return ColorId::Adobe;
   case 2: return ColorId::Magenta;
   case 3: return ColorId::LightBlue;
   case 4: return ColorId::Yellow;
   case 5: return ColorId::Lime;
   case 6: return ColorId::Pink;
   case 7: return ColorId::Gray;
   case 8: return ColorId::LightGray;
   case 9: return ColorId::Cyan;
   case 10: return ColorId::Purple;
   case 11: return ColorId::Blue;
   case 12: return ColorId::Brown;
   case 13: return ColorId::Green;
   case 14: return ColorId::Red;
   case 15: return ColorId::Black;
   }
