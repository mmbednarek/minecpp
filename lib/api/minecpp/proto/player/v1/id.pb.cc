...
// @@protoc_insertion_point(message_byte_size_start:minecpp.proto.player.v1.PlayerId)
  ...
  // uint64 lower = 1;
  if (this->_internal_lower() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64SizePlusOne(this->_internal_lower());
  }

  // uint64 upper = 2;
  if (this->_internal_upper() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64SizePlusOne(this->_internal_upper());
  }
