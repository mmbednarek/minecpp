...
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_minecpp_2fproto_2fentity_2fEntity_2eproto = nullptr;

const uint32_t TableStruct_minecpp_2fproto_2fentity_2fEntity_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 13, -1, -1, sizeof(::minecpp::proto::entity::Metadata)},
  { 23, -1, -1, sizeof(::minecpp::proto::entity::Entity)},
  { 38, -1, -1, sizeof(::minecpp::proto::entity::EntityEquipment)},
  { 46, -1, -1, sizeof(::minecpp::proto::entity::PlayerEntity)},
};
...
static ::_pbi::once_flag descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto = {
    false, false, 1151, descriptor_table_protodef_minecpp_2fproto_2fentity_2fEntity_2eproto,
    "minecpp/proto/entity/Entity.proto",
    &descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto_once, descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto_deps, 2, 5,
    schemas, file_default_instances, TableStruct_minecpp_2fproto_2fentity_2fEntity_2eproto::offsets,
    file_level_metadata_minecpp_2fproto_2fentity_2fEntity_2eproto, file_level_enum_descriptors_minecpp_2fproto_2fentity_2fEntity_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_minecpp_2fproto_2fentity_2fEntity_2eproto(&descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto);
namespace minecpp {
namespace proto {
namespace entity {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EquipmentSlot_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_minecpp_2fproto_2fentity_2fEntity_2eproto);
...
const ::minecpp::proto::common::UUID&
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_slot(static_cast<::minecpp::proto::entity::EquipmentSlot>(val));
        } else
          goto handle_unusual;
        continue;
...
template<> PROTOBUF_NOINLINE ::minecpp::proto::entity::Abilities*
Arena::CreateMaybeMessage< ::minecpp::proto::entity::Abilities >(Arena* arena) {
  return Arena::CreateMessageInternal< ::minecpp::proto::entity::Abilities >(arena);
}
template<> PROTOBUF_NOINLINE ::minecpp::proto::entity::Metadata*
Arena::CreateMaybeMessage< ::minecpp::proto::entity::Metadata >(Arena* arena) {
  return Arena::CreateMessageInternal< ::minecpp::proto::entity::Metadata >(arena);
}
template<> PROTOBUF_NOINLINE ::minecpp::proto::entity::Entity*
Arena::CreateMaybeMessage< ::minecpp::proto::entity::Entity >(Arena* arena) {
  return Arena::CreateMessageInternal< ::minecpp::proto::entity::Entity >(arena);
}
template<> PROTOBUF_NOINLINE ::minecpp::proto::entity::EntityEquipment*
Arena::CreateMaybeMessage< ::minecpp::proto::entity::EntityEquipment >(Arena* arena) {
  return Arena::CreateMessageInternal< ::minecpp::proto::entity::EntityEquipment >(arena);
}
template<> PROTOBUF_NOINLINE ::minecpp::proto::entity::PlayerEntity*
Arena::CreateMaybeMessage< ::minecpp::proto::entity::PlayerEntity >(Arena* arena) {
  return Arena::CreateMessageInternal< ::minecpp::proto::entity::PlayerEntity >(arena);
}
