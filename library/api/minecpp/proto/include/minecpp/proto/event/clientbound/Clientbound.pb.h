...
#ifndef GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fevent_2fclientbound_2fClientbound_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fevent_2fclientbound_2fClientbound_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_minecpp_2fproto_2fevent_2fclientbound_2fClientbound_2eproto;
namespace minecpp {
namespace proto {
namespace event {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::minecpp::proto::event::clientbound::AcceptPlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::AcceptPlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::AcknowledgeBlockChange* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::AcknowledgeBlockChange>(Arena*);
template<> ::minecpp::proto::event::clientbound::AddPlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::AddPlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::AnimateEntity* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::AnimateEntity>(Arena*);
template<> ::minecpp::proto::event::clientbound::Chat* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::Chat>(Arena*);
template<> ::minecpp::proto::event::clientbound::ChunkBlockLight* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::ChunkBlockLight>(Arena*);
template<> ::minecpp::proto::event::clientbound::ChunkData* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::ChunkData>(Arena*);
template<> ::minecpp::proto::event::clientbound::CollectItem* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::CollectItem>(Arena*);
template<> ::minecpp::proto::event::clientbound::DenyPlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::DenyPlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::DisplayDeathScreen* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::DisplayDeathScreen>(Arena*);
template<> ::minecpp::proto::event::clientbound::EntityList* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::EntityList>(Arena*);
template<> ::minecpp::proto::event::clientbound::EntityLook* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::EntityLook>(Arena*);
template<> ::minecpp::proto::event::clientbound::EntityMove* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::EntityMove>(Arena*);
template<> ::minecpp::proto::event::clientbound::Event* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::Event>(Arena*);
template<> ::minecpp::proto::event::clientbound::LoadTerrain* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::LoadTerrain>(Arena*);
template<> ::minecpp::proto::event::clientbound::PlayerList* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::PlayerList>(Arena*);
template<> ::minecpp::proto::event::clientbound::PlayerPositionRotation* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::PlayerPositionRotation>(Arena*);
template<> ::minecpp::proto::event::clientbound::RecipientAllPlayers* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RecipientAllPlayers>(Arena*);
template<> ::minecpp::proto::event::clientbound::RecipientExcluding* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RecipientExcluding>(Arena*);
template<> ::minecpp::proto::event::clientbound::RecipientMultiplePlayers* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RecipientMultiplePlayers>(Arena*);
template<> ::minecpp::proto::event::clientbound::RecipientSinglePlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RecipientSinglePlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::RemoveEntity* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RemoveEntity>(Arena*);
template<> ::minecpp::proto::event::clientbound::RemovePlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::RemovePlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::Respawn* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::Respawn>(Arena*);
template<> ::minecpp::proto::event::clientbound::SectionBlockLight* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SectionBlockLight>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetAbilities* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetAbilities>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetCenterChunk* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetCenterChunk>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetEntityEquipment* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetEntityEquipment>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetEntityVelocity* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetEntityVelocity>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetHealth* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetHealth>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetInventorySlot* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetInventorySlot>(Arena*);
template<> ::minecpp::proto::event::clientbound::SetSpawnPosition* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SetSpawnPosition>(Arena*);
template<> ::minecpp::proto::event::clientbound::SpawnEntity* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SpawnEntity>(Arena*);
template<> ::minecpp::proto::event::clientbound::SpawnPlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::SpawnPlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::TeleportEntity* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::TeleportEntity>(Arena*);
template<> ::minecpp::proto::event::clientbound::TransferPlayer* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::TransferPlayer>(Arena*);
template<> ::minecpp::proto::event::clientbound::UnloadChunk* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::UnloadChunk>(Arena*);
template<> ::minecpp::proto::event::clientbound::UpdateBlock* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::UpdateBlock>(Arena*);
template<> ::minecpp::proto::event::clientbound::UpdateBlockLight* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::UpdateBlockLight>(Arena*);
template<> ::minecpp::proto::event::clientbound::UpdatePlayerAbilities* Arena::CreateMaybeMessage<::minecpp::proto::event::clientbound::UpdatePlayerAbilities>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace minecpp {
namespace proto {
namespace event {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fevent_2fclientbound_2fClientbound_2eproto
