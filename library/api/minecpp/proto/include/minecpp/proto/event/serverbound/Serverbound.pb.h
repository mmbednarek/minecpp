...
template <>
::minecpp::proto::event::serverbound::AnimateHand* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::AnimateHand>(Arena*);
template <>
::minecpp::proto::event::serverbound::BlockPlacement* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::BlockPlacement>(Arena*);
template <>
::minecpp::proto::event::serverbound::ChangeHeldItem* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::ChangeHeldItem>(Arena*);
template <>
::minecpp::proto::event::serverbound::ChangeInventoryItem* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::ChangeInventoryItem>(Arena*);
template <>
::minecpp::proto::event::serverbound::ChatMessage* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::ChatMessage>(Arena*);
template <>
::minecpp::proto::event::serverbound::DropInventoryItem* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::DropInventoryItem>(Arena*);
template <>
::minecpp::proto::event::serverbound::Event* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::Event>(Arena*);
template <>
::minecpp::proto::event::serverbound::Interact* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::Interact>(Arena*);
template <>
::minecpp::proto::event::serverbound::IssueCommand* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::IssueCommand>(Arena*);
template <>
::minecpp::proto::event::serverbound::PlayerDigging* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::PlayerDigging>(Arena*);
template <>
...
template <>
::minecpp::proto::event::serverbound::RequestRespawn* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::RequestRespawn>(Arena*);
template <>
::minecpp::proto::event::serverbound::SetCarriedItem* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::SetCarriedItem>(Arena*);
template <>
::minecpp::proto::event::serverbound::SetPlayerOnGround* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::SetPlayerOnGround>(Arena*);
template <>
::minecpp::proto::event::serverbound::SetPlayerPosition* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::SetPlayerPosition>(Arena*);
template <>
::minecpp::proto::event::serverbound::SetPlayerPositionRotation* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::SetPlayerPositionRotation>(Arena*);
template <>
::minecpp::proto::event::serverbound::SetPlayerRotation* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::SetPlayerRotation>(Arena*);
template <>
::minecpp::proto::event::serverbound::UpdatePing* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::UpdatePing>(Arena*);
template <>
::minecpp::proto::event::serverbound::UseItem* Arena::CreateMaybeMessage<::minecpp::proto::event::serverbound::UseItem>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline bool PlayerDigging::has_block_position() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.block_position_ != nullptr);
  return value;
}
...
inline bool SetCarriedItem::has_carried_item_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.carried_item_id_ != nullptr);
  return value;
}
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void IssueCommand::set_command(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void IssueCommand::set_allocated_command(std::string* value) {
