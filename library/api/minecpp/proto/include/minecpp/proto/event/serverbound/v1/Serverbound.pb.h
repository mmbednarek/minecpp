...
{
 public:
   inline LoadInitialChunks() :
       LoadInitialChunks(nullptr)
   {
   }
...
inline void
SetPlayerPosition::unsafe_arena_set_allocated_position(::minecpp::proto::entity::v1::Position *position)
{
   if (GetArenaForAllocation() == nullptr) {
...
inline void
SetPlayerRotation::unsafe_arena_set_allocated_rotation(::minecpp::proto::entity::v1::Rotation *rotation)
{
   if (GetArenaForAllocation() == nullptr) {
