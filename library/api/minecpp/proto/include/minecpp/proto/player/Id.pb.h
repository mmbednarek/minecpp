...
#ifndef GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fplayer_2fId_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fplayer_2fId_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_minecpp_2fproto_2fplayer_2fId_2eproto;
namespace minecpp {
namespace proto {
namespace player {
class PlayerId;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::minecpp::proto::player::PlayerId* Arena::CreateMaybeMessage<::minecpp::proto::player::PlayerId>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace minecpp {
namespace proto {
namespace player {
...
class PlayerId final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:minecpp.proto.player.PlayerId) */ {
 public:
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_minecpp_2fproto_2fplayer_2fId_2eproto
