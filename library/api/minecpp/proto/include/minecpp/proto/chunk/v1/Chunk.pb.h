...
template<>
::minecpp::proto::chunk::v1::Section *
Arena::CreateMaybeMessage<::minecpp::proto::chunk::v1::Section>(Arena *);
template<>
::minecpp::proto::chunk::v1::SectionSlice *
Arena::CreateMaybeMessage<::minecpp::proto::chunk::v1::SectionSlice>(Arena *);
template<>
::minecpp::proto::chunk::v1::SectionWithPosition *
Arena::CreateMaybeMessage<::minecpp::proto::chunk::v1::SectionWithPosition>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
...
class Section final
    : public ::PROTOBUF_NAMESPACE_ID::
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.chunk.v1.Section) */
{
 public:
   inline Section() :
       Section(nullptr)
   ...
   {
      return reinterpret_cast<const Section *>(&_Section_default_instance_);
   }
 ...
 protected:
   explicit Section(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned = false);
              ...
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.chunk.v1.Chunk) */
{
 ...
 public:
   ...
   ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::minecpp::proto::chunk::v1::Section> *mutable_sections();
 ...
 public:
   ...
   const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::minecpp::proto::chunk::v1::Section> &sections() const;
...
class SectionWithPosition final
    : public ::PROTOBUF_NAMESPACE_ID::
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.chunk.v1.SectionWithPosition) */
{
 public:
   inline SectionWithPosition() :
       SectionWithPosition(nullptr)
   {
   }
   ...
   {
      return reinterpret_cast<const SectionWithPosition *>(&_SectionWithPosition_default_instance_);
   }
 ...
 protected:
   explicit SectionWithPosition(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned = false);
 ...
 public:
   void unsafe_arena_set_allocated_position(::minecpp::proto::common::v1::ChunkSectionPosition *position);
 ...
 public:
   void unsafe_arena_set_allocated_section(::minecpp::proto::chunk::v1::Section *section);
...
class SectionSlice final
    : public ::PROTOBUF_NAMESPACE_ID::
              Message /* @@protoc_insertion_point(class_definition:minecpp.proto.chunk.v1.SectionSlice) */
{
 public:
   inline SectionSlice() :
       SectionSlice(nullptr)
   {
   }
   ...
   {
      return reinterpret_cast<const SectionSlice *>(&_SectionSlice_default_instance_);
   }
 ...
 protected:
   explicit SectionSlice(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned = false);
 ...
 public:
   void unsafe_arena_set_allocated_range(::minecpp::proto::common::v1::SectionRange *range);
...
inline PROTOBUF_ALWAYS_INLINE void Section::set_block_light(ArgT0 &&arg0, ArgT... args)
{
...
template<typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void Section::set_sky_light(ArgT0 &&arg0, ArgT... args)
{
...
inline void Chunk::unsafe_arena_set_allocated_position(::minecpp::proto::common::v1::ChunkPosition *position)
{
...
inline const ::minecpp::proto::common::v1::ChunkSectionPosition &
SectionWithPosition::_internal_position() const
{
...
inline ::minecpp::proto::common::v1::ChunkSectionPosition *
SectionWithPosition::unsafe_arena_release_position()
{
...
inline void
SectionWithPosition::set_allocated_position(::minecpp::proto::common::v1::ChunkSectionPosition *position)
{
   ::PROTOBUF_NAMESPACE_ID::Arena *message_arena = GetArenaForAllocation();
   if (message_arena == nullptr) {
      delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite *>(_impl_.position_);
...
inline const ::minecpp::proto::chunk::v1::Section &SectionWithPosition::_internal_section() const
{
   ...
   return p != nullptr ? *p
                       : reinterpret_cast<const ::minecpp::proto::chunk::v1::Section &>(
...
inline void
SectionWithPosition::unsafe_arena_set_allocated_section(::minecpp::proto::chunk::v1::Section *section)
{
   if (GetArenaForAllocation() == nullptr) {
...
inline void SectionWithPosition::set_allocated_section(::minecpp::proto::chunk::v1::Section *section)
{
   ...
   if (section) {
      ...
      if (message_arena != submessage_arena) {
         section =
                 ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(message_arena, section, submessage_arena);
      }
...
inline const ::minecpp::proto::common::v1::SectionRange &SectionSlice::_internal_range() const
{
   ...
   return p != nullptr ? *p
                       : reinterpret_cast<const ::minecpp::proto::common::v1::SectionRange &>(
...
inline void SectionSlice::unsafe_arena_set_allocated_range(::minecpp::proto::common::v1::SectionRange *range)
{
   if (GetArenaForAllocation() == nullptr) {
...
inline const ::minecpp::proto::chunk::v1::SectionWithPosition &
SectionSlice::_internal_sections(int index) const
{
   return _impl_.sections_.Get(index);
}
