 ...
 public:
   ...
   class StubInterface
   {
    public:
      ...
      std::unique_ptr<::grpc::ClientReaderWriterInterface<::minecpp::proto::service::storage::v1::Request,
                                                          ::minecpp::proto::service::storage::v1::Response>>
      Join(::grpc::ClientContext *context)
      {
         return std::unique_ptr<
                 ::grpc::ClientReaderWriterInterface<::minecpp::proto::service::storage::v1::Request,
                                                     ::minecpp::proto::service::storage::v1::Response>>(
                 JoinRaw(context));
      }

      std::unique_ptr<
              ::grpc::ClientAsyncReaderWriterInterface<::minecpp::proto::service::storage::v1::Request,
                                                       ::minecpp::proto::service::storage::v1::Response>>
      ...
      class async_interface
      {
       public:
         ...
         virtual void
         Join(::grpc::ClientContext *context,
              ::grpc::ClientBidiReactor<::minecpp::proto::service::storage::v1::Request,
                                        ::minecpp::proto::service::storage::v1::Response> *reactor) = 0;
      };
    ...
    private:
      virtual ::grpc::ClientReaderWriterInterface<::minecpp::proto::service::storage::v1::Request,
                                                  ::minecpp::proto::service::storage::v1::Response> *
      JoinRaw(::grpc::ClientContext *context) = 0;
      virtual ::grpc::ClientAsyncReaderWriterInterface<::minecpp::proto::service::storage::v1::Request,
                                                       ::minecpp::proto::service::storage::v1::Response> *
   ...
   class Stub final : public StubInterface
   {
    public:
      ...
      std::unique_ptr<::grpc::ClientReaderWriter<::minecpp::proto::service::storage::v1::Request,
                                                 ::minecpp::proto::service::storage::v1::Response>>
      Join(::grpc::ClientContext *context)
      {
         return std::unique_ptr<::grpc::ClientReaderWriter<::minecpp::proto::service::storage::v1::Request,
                                                           ::minecpp::proto::service::storage::v1::Response>>(
                 JoinRaw(context));
      }

      std::unique_ptr<::grpc::ClientAsyncReaderWriter<::minecpp::proto::service::storage::v1::Request,
                                                      ::minecpp::proto::service::storage::v1::Response>>
      AsyncJoin(::grpc::ClientContext *context, ::grpc::CompletionQueue *cq, void *tag)
      {
         return std::unique_ptr<
                 ::grpc::ClientAsyncReaderWriter<::minecpp::proto::service::storage::v1::Request,
                                                 ::minecpp::proto::service::storage::v1::Response>>(
                 AsyncJoinRaw(context, cq, tag));
      }
      ...
      class async final : public StubInterface::async_interface
      {
       public:
         ...
         Join(::grpc::ClientContext *context,
              ::grpc::ClientBidiReactor<::minecpp::proto::service::storage::v1::Request,
                                        ::minecpp::proto::service::storage::v1::Response> *reactor) override;
    ...
    private:
      ...
      ::grpc::ClientReaderWriter<::minecpp::proto::service::storage::v1::Request,
                                 ::minecpp::proto::service::storage::v1::Response> *
   ...
   class WithAsyncMethod_Join : public BaseClass
   {
    ...
    public:
      ...
      Join(::grpc::ServerContext * /*context*/,
           ::grpc::ServerReaderWriter<::minecpp::proto::service::storage::v1::Response,
                                      ::minecpp::proto::service::storage::v1::Request> * /*stream*/) override
      {
         abort();
      ...
      RequestJoin(::grpc::ServerContext *context,
                  ::grpc::ServerAsyncReaderWriter<::minecpp::proto::service::storage::v1::Response,
                                                  ::minecpp::proto::service::storage::v1::Request> *stream,
    ...
    public:
      WithCallbackMethod_Join()
      {
         ::grpc::Service::MarkMethodCallback(
                 0,
                 new ::grpc::internal::CallbackBidiHandler<::minecpp::proto::service::storage::v1::Request,
                                                           ::minecpp::proto::service::storage::v1::Response>(
      ...
      virtual ::grpc::ServerBidiReactor<::minecpp::proto::service::storage::v1::Request,
                                        ::minecpp::proto::service::storage::v1::Response> *
