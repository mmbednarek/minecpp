...
{
   Entity res;
   r.read_compound([&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid,
                          const std::string &in_field_name) {
      switch (tagid) {
      case minecpp::nbt::TagId::Byte: res.set_property(in_field_name, r.read_byte()); return;
      case minecpp::nbt::TagId::Short: res.set_property(in_field_name, r.read_short()); return;
      case minecpp::nbt::TagId::Int: res.set_property(in_field_name, r.read_int()); return;
      case minecpp::nbt::TagId::String: res.set_property(in_field_name, r.read_str()); return;
      case minecpp::nbt::TagId::Float: res.set_property(in_field_name, r.read_float32()); return;
      case minecpp::nbt::TagId::IntArray: res.set_property(in_field_name, r.read_int_vec()); return;
      case minecpp::nbt::TagId::Compound:
...
Heightmaps Heightmaps::deserialize_no_header(minecpp::nbt::Reader &r)
{
   ...
   r.read_compound(
           [&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid, const std::string &in_field_name) {
              switch (tagid) {
              case minecpp::nbt::TagId::LongArray: res.set_property(in_field_name, r.read_long_vec()); return;
              default: break;
              }
              r.skip_payload(tagid);
           });
           ...
           [&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid, const std::string &in_field_name) {
              ...
              case minecpp::nbt::TagId::Compound:
                 if (in_field_name == "Properties") {
                    res.set_property(in_field_name, r.read_compound_content());
                    return;
                 }
                 break;
              default: break;
   ...
   r.read_compound(
           [&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid, const std::string &in_field_name) {
              ...
              case minecpp::nbt::TagId::ByteArray:
                 res.set_property(in_field_name, r.read_byte_vector());
                 return;
              case minecpp::nbt::TagId::LongArray: res.set_property(in_field_name, r.read_long_vec()); return;
              case minecpp::nbt::TagId::List: {
                 auto list_info0 = r.peek_list();
              ...
              case minecpp::nbt::TagId::Compound:
                 if (in_field_name == "Starts") {
                    r.read_compound([&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid,
                       ...
                       res.starts.insert(std::make_pair(in_field_name, Start::deserialize_no_header(r)));
                    });
                    return;
                 }
                 break;
   ...
   r.read_compound([&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid,
      ...
      case minecpp::nbt::TagId::Compound:
         if (in_field_name == "CarvingMasks") {
            res.set_property(in_field_name, CarvingMasks::deserialize_no_header(r));
            return;
         }
         if (in_field_name == "Heightmaps") {
            res.set_property(in_field_name, Heightmaps::deserialize_no_header(r));
            return;
         }
         if (in_field_name == "Structures") {
            res.set_property(in_field_name, Structures::deserialize_no_header(r));
            return;
         }
         break;
      case minecpp::nbt::TagId::List: {
           ...
           [&res](minecpp::nbt::Reader &r, minecpp::nbt::TagId tagid, const std::string &in_field_name) {
              ...
              case minecpp::nbt::TagId::Compound:
                 if (in_field_name == "Level") {
                    res.set_property(in_field_name, Level::deserialize_no_header(r));
                    return;
                 }
                 break;
              default: break;
