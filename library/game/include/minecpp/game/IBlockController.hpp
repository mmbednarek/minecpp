...
class IBlockController
{
 public:
   ...
   virtual std::optional<BlockStateId> on_neighbour_change(World &world,
                                                                 BlockStateId block_state_id,
    ...
    */
   virtual bool on_player_action(World &world, PlayerId player_id,
                                 BlockStateId block_state_id, BlockPosition position,
                                 Face face, util::Vec3 crosshair_position) = 0;
};
